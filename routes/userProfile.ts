...
router.post("/removePostFromAlbums", profileController.deletePostIdFromalbum);
router.post("/otherPostShowInAlbums", profileController.otherPostShowInAlbums);
...
router.post(
  "/removePostFromAlbumsFromHome",
  profileController.deletePostInAlbumFromHome
);
router.get("/posts", profileController.onepost);
